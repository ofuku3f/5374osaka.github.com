...
このバグはリフレッシュするコードがまだ入っていないために起こるバグです。(2015.8.12)

・同じ町内の一部狭路への表示の扱いは、コメントで対応予定です。このコメントについても、現在表示ができない状態ですが、本家の5374のコードを追加することによって対応できそうなので、対応予定です。(2015.8.12)

・同じ町内で、小型金属の収集場所が異なる場合の表示もコメントによる表示によって対応予定です。上記のコード修正により対応可能と考えています。(2015.8.12)

・2015.8.9のイベントでの質問(http://peatix.com/event/104283)で、色覚異常への対応が、本家5374でも対応されていない（チェック)されていないとのことです。ただこれは自治体によって色が決まっているそうで、京都市版も調査後、検討したいと考えています。

・他言語版や読み上げにも対応予定との事なので、京都市版も検討したいと思います。
